...
BasicArmCommand::Arm::Arm(BaseSmartJoint *elbow, BaseSmartJoint *shoulder, double elbowLength, double shoulderLength) {
	Elbow = elbow;
	Shoulder = shoulder;
...
BasicArmCommand::SetJointSpeed::SetJointSpeed(BaseJoint *joint, double speed) :
...
BasicArmCommand::ControlWinchManual::ControlWinchManual(BaseWinch *winch, Axis *axis) :
